...
func main() {
	...
	for {
		...
		log.Println("ArmingStatus:", asr.Areas[0].ArmingStatus.String())
		log.Println("ArmUpState  :", asr.Areas[0].ArmUpState.String())
		log.Println("AlarmState  :", asr.Areas[0].AlarmState.String())
	}
}
